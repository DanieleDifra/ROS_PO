...
// Block signals for system '<S12>/Coordinate Transformation Conversion'
typedef struct {
  real_T CoordinateTransformationConve_g[16];
                                // '<S12>/Coordinate Transformation Conversion'
  real_T R[9];
  real_T tempR[9];
  real_T u1[3];
  real_T b;
...
// Block states (default storage) for system '<S12>/Coordinate Transformation Conversion' 
typedef struct {
  robotics_slcore_internal_bloc_T obj;
                                // '<S12>/Coordinate Transformation Conversion'
  boolean_T objisempty;         // '<S12>/Coordinate Transformation Conversion'
...
typedef struct {
  ...
  g_cell_wrap_cartesian_traject_T coeffsCell[6];
  ...
  f_cell_wrap_cartesian_traject_T breaksCell[6];
  real_T breakMat[24];
  ...
  real_T res_max_vel[6];               // '<Root>/MATLAB Function'
  real_T TmpMLSysMemLayoutBufferAt_m[6];// '<S2>/MATLAB System'
  ...
  boolean_T coeffIndex_data_g[36];
  boolean_T coeffIndex_data_m[36];
  boolean_T coeffIndex_data_n[36];
  boolean_T coeffIndex_data_p[36];
  boolean_T coeffIndex_data_l[36];
  ...
  char_T cv[18];
  int32_T g_data[4];
  SL_Bus_cartesian_trajectory_planner_2_rosgraph_msgs_Clock In1;// '<S11>/In1'
  SL_Bus_cartesian_trajectory_planner_2_rosgraph_msgs_Clock b_varargout_2_j;
  real_T unusedU13[2];
  char_T cv1[13];
  int32_T num[3];
  char_T cv2[11];
  ...
  int32_T modBreaks_size_b[2];
  int32_T modBreaks_size_l[2];
  int32_T dCoefs_size[2];
  int32_T breaks_size_h[2];
  int32_T breaks_size_b[2];
  int32_T breaks_size_d[2];
  char_T cv3[7];
  ...
  int32_T loop_ub_m;
  int32_T m_tmp;
  int32_T coefsWithFlatStart_size_idx_0_c;
  int32_T m_tmp_m;
  int32_T loop_ub_tmp;
  int32_T loop_ub_m3;
  int32_T ip;
...
typedef struct {
  robotics_slcore_internal_bl_j_T obj;
                            // '<Root>/Trapezoidal Velocity Profile Trajectory'
  ros_slros_internal_block_GetP_T obj_d;// '<S10>/Get Parameter'
  ros_slros_internal_block_GetP_T obj_m;// '<S10>/Get Parameter1'
  ros_slros_internal_block_GetP_T obj_c;// '<S10>/Get Parameter2'
  ros_slros_internal_block_GetP_T obj_f;// '<S10>/Get Parameter3'
  ros_slros_internal_block_GetP_T obj_e;// '<S10>/Get Parameter4'
  ros_slros_internal_block_GetP_T obj_a;// '<S10>/Get Parameter5'
  ros_slros_internal_block_GetP_T obj_o;// '<S13>/Get Parameter3'
  ros_slros_internal_block_GetP_T obj_es;// '<S13>/Get Parameter4'
  ros_slros_internal_block_GetP_T obj_f4;// '<S13>/Get Parameter5'
  ros_slros_internal_block_GetP_T obj_en;// '<S13>/Get Parameter6'
  ros_slros_internal_block_GetP_T obj_b;// '<S13>/Get Parameter'
  ros_slros_internal_block_GetP_T obj_i;// '<S13>/Get Parameter1'
  ros_slros_internal_block_GetP_T obj_db;// '<S13>/Get Parameter2'
  ros_slros_internal_block_GetP_T obj_e0;// '<S12>/Get Parameter3'
  ros_slros_internal_block_GetP_T obj_p;// '<S12>/Get Parameter4'
  ros_slros_internal_block_GetP_T obj_g;// '<S12>/Get Parameter5'
  ros_slros_internal_block_GetP_T obj_or;// '<S12>/Get Parameter6'
  ros_slros_internal_block_GetP_T obj_a3;// '<S12>/Get Parameter'
  ros_slros_internal_block_GetP_T obj_bh;// '<S12>/Get Parameter1'
  ros_slros_internal_block_GetP_T obj_b0;// '<S12>/Get Parameter2'
...
struct P_cartesian_trajectory_planne_T_ {
  ...
  real_T Constant_Value_o[6];          // Expression: [0, 0, 0, 0, 0, 0]
...
//  '<S4>'   : 'cartesian_trajectory_planner_2/MATLAB Function'
//  '<S5>'   : 'cartesian_trajectory_planner_2/MATLAB Function1'
//  '<S6>'   : 'cartesian_trajectory_planner_2/MATLAB Function2'
...
//  '<S10>'  : 'cartesian_trajectory_planner_2/Subsystem1'
//  '<S11>'  : 'cartesian_trajectory_planner_2/Subscribe/Enabled Subsystem'
//  '<S12>'  : 'cartesian_trajectory_planner_2/Subsystem/Subsystem'
//  '<S13>'  : 'cartesian_trajectory_planner_2/Subsystem/Subsystem1'
