...
#ifndef typedef_sg9AtqjjkXglWcXWTAtiJmG_kinsi_T
#define typedef_sg9AtqjjkXglWcXWTAtiJmG_kinsi_T

typedef struct tag_sg9AtqjjkXglWcXWTAtiJmG sg9AtqjjkXglWcXWTAtiJmG_kinsi_T;

#endif                                 //typedef_sg9AtqjjkXglWcXWTAtiJmG_kinsi_T
...
typedef struct tag_BPMfb1nwAW0cVckEDiFVnG n_robotics_manip_internal_R_l_T;
...
#ifndef typedef_o_robotics_manip_internal_R_l_T
#define typedef_o_robotics_manip_internal_R_l_T

typedef struct tag_EpnOXkcFkOFmcaZiu2CuCD o_robotics_manip_internal_R_l_T;

#endif                                 //typedef_o_robotics_manip_internal_R_l_T
...
{
  real_T NumBodies;
  o_robotics_manip_internal_R_l_T Base;
  n_robotics_manip_internal_R_l_T *Bodies[8];
  real_T PositionNumber;
};

#endif                                 //struct_tag_30tOpKFHjBx7LOwU1qyzZE

#ifndef typedef_p_robotics_manip_internal_R_l_T
#define typedef_p_robotics_manip_internal_R_l_T

typedef struct tag_30tOpKFHjBx7LOwU1qyzZE p_robotics_manip_internal_R_l_T;

#endif                                 //typedef_p_robotics_manip_internal_R_l_T
...
{
  int32_T isInitialized;
  p_robotics_manip_internal_R_l_T TreeInternal;
};
...
typedef struct tag_OhlsWxsKBuXkrIadR09rYF robotics_slmanip_internal_b_l_T;
