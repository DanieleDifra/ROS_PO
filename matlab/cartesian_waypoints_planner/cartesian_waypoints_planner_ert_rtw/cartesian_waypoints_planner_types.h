...
//
// File: cartesian_waypoints_planner_types.h
//
...
//
#ifndef RTW_HEADER_cartesian_waypoints_planner_types_h_
#define RTW_HEADER_cartesian_waypoints_planner_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_waypoints_planner_std_msgs_Header_
#define DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_waypoints_planner_std_msgs_Header_
...
typedef struct {
  ...
  // MsgType=ros_time/Time
  SL_Bus_cartesian_waypoints_planner_ros_time_Time Stamp;
} SL_Bus_cartesian_waypoints_planner_std_msgs_Header;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_waypoints_planner_geometry_msgs_Point_
#define DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_waypoints_planner_geometry_msgs_Point_
...
typedef struct {
  ...
  real_T Y;
  real_T Z;
} SL_Bus_cartesian_waypoints_planner_geometry_msgs_Point;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_waypoints_planner_geometry_msgs_Quaternion_
#define DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_waypoints_planner_geometry_msgs_Quaternion_
...
typedef struct {
  ...
  real_T Z;
  real_T W;
} SL_Bus_cartesian_waypoints_planner_geometry_msgs_Quaternion;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_waypoints_planner_geometry_msgs_Pose_
#define DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_waypoints_planner_geometry_msgs_Pose_

// MsgType=geometry_msgs/Pose
typedef struct {
  // MsgType=geometry_msgs/Point
  SL_Bus_cartesian_waypoints_planner_geometry_msgs_Point Position;

  // MsgType=geometry_msgs/Quaternion
  SL_Bus_cartesian_waypoints_planner_geometry_msgs_Quaternion Orientation;
} SL_Bus_cartesian_waypoints_planner_geometry_msgs_Pose;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_waypoints_plann_PoseStamped_hk4udn_
#define DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_waypoints_plann_PoseStamped_hk4udn_

// MsgType=geometry_msgs/PoseStamped
typedef struct {
  // MsgType=std_msgs/Header
  SL_Bus_cartesian_waypoints_planner_std_msgs_Header Header;

  // MsgType=geometry_msgs/Pose
  SL_Bus_cartesian_waypoints_planner_geometry_msgs_Pose Pose;
} SL_Bus_cartesian_waypoints_plann_PoseStamped_hk4udn;
...
#ifndef typedef_emxArray_char_T_cartesian_way_T
#define typedef_emxArray_char_T_cartesian_way_T

typedef struct emxArray_char_T emxArray_char_T_cartesian_way_T;

#endif                                 //typedef_emxArray_char_T_cartesian_way_T
...
#ifndef typedef_emxArray_real_T_cartesian_way_T
#define typedef_emxArray_real_T_cartesian_way_T

typedef struct emxArray_real_T emxArray_real_T_cartesian_way_T;

#endif                                 //typedef_emxArray_real_T_cartesian_way_T
...
#ifndef typedef_emxArray_int32_T_cartesian_wa_T
#define typedef_emxArray_int32_T_cartesian_wa_T

typedef struct emxArray_int32_T emxArray_int32_T_cartesian_wa_T;

#endif                                 //typedef_emxArray_int32_T_cartesian_wa_T
...
struct tag_a9w8IowFHzogdOiVBZxs7
{
  ...
  real_T VelocityNumber;
  real_T PositionNumber;
  emxArray_real_T_cartesian_way_T *MotionSubspace;
  boolean_T InTree;
  real_T JointToParentTransform[16];
  real_T ChildToJointTransform[16];
  emxArray_char_T_cartesian_way_T *NameInternal;
  emxArray_real_T_cartesian_way_T *PositionLimitsInternal;
  emxArray_real_T_cartesian_way_T *HomePositionInternal;
...
struct tag_KnC6mlO1VBfnPbaet73v2G
{
  ...
  real_T Tform[16];
  emxArray_real_T_cartesian_way_T *ErrTemp;
  real_T CostTemp;
  emxArray_real_T_cartesian_way_T *GradTemp;
};
...
{
  char_T Name[22];
  emxArray_real_T_cartesian_way_T *ConstraintMatrix;
  emxArray_real_T_cartesian_way_T *ConstraintBound;
...
typedef struct tag_2xAJzS7rvIyFzfuC7FOGlD c_rigidBodyJoint_cartesian__e_T;
...
typedef struct P_cartesian_waypoints_planner_T_ P_cartesian_waypoints_planner_T;

// Forward declaration for rtModel
typedef struct tag_RTM_cartesian_waypoints_p_T RT_MODEL_cartesian_waypoints__T;

#endif                       // RTW_HEADER_cartesian_waypoints_planner_types_h_
