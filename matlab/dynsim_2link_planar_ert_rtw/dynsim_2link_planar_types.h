...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_2link_planar_geometry_msgs_Point_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_2link_planar_geometry_msgs_Point_
...
typedef struct {
  ...
  real_T Y;
  real_T Z;
} SL_Bus_dynsim_2link_planar_geometry_msgs_Point;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_2link_planar_geometry_msgs_Quaternion_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_2link_planar_geometry_msgs_Quaternion_
...
typedef struct {
  ...
  real_T Z;
  real_T W;
} SL_Bus_dynsim_2link_planar_geometry_msgs_Quaternion;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_2link_planar_geometry_msgs_Pose_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_2link_planar_geometry_msgs_Pose_

// MsgType=geometry_msgs/Pose
typedef struct {
  // MsgType=geometry_msgs/Point
  SL_Bus_dynsim_2link_planar_geometry_msgs_Point Position;

  // MsgType=geometry_msgs/Quaternion
  SL_Bus_dynsim_2link_planar_geometry_msgs_Quaternion Orientation;
} SL_Bus_dynsim_2link_planar_geometry_msgs_Pose;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_2link_planar_geometry_msgs_PoseStamped_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_2link_planar_geometry_msgs_PoseStamped_
...
typedef struct {
  ...
  // MsgType=geometry_msgs/Pose
  SL_Bus_dynsim_2link_planar_geometry_msgs_Pose Pose;
} SL_Bus_dynsim_2link_planar_geometry_msgs_PoseStamped;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_2link_planar_geometry_msgs_Vector3_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_2link_planar_geometry_msgs_Vector3_
...
typedef struct {
  ...
  real_T Y;
  real_T Z;
} SL_Bus_dynsim_2link_planar_geometry_msgs_Vector3;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_2link_planar_geometry_msgs_Twist_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_2link_planar_geometry_msgs_Twist_

// MsgType=geometry_msgs/Twist
typedef struct {
  // MsgType=geometry_msgs/Vector3
  SL_Bus_dynsim_2link_planar_geometry_msgs_Vector3 Linear;

  // MsgType=geometry_msgs/Vector3
  SL_Bus_dynsim_2link_planar_geometry_msgs_Vector3 Angular;
} SL_Bus_dynsim_2link_planar_geometry_msgs_Twist;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_2link_planar_geometry_msgs_TwistStamped_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_2link_planar_geometry_msgs_TwistStamped_
...
typedef struct {
  ...
  // MsgType=geometry_msgs/Twist
  SL_Bus_dynsim_2link_planar_geometry_msgs_Twist Twist;
} SL_Bus_dynsim_2link_planar_geometry_msgs_TwistStamped;
...
#ifndef typedef_sS24XwgKvOMFYbEXa7sc1bB_dynsi_T
#define typedef_sS24XwgKvOMFYbEXa7sc1bB_dynsi_T

typedef struct tag_sS24XwgKvOMFYbEXa7sc1bB sS24XwgKvOMFYbEXa7sc1bB_dynsi_T;

#endif                                 //typedef_sS24XwgKvOMFYbEXa7sc1bB_dynsi_T
...
#ifndef typedef_f_cell_wrap_dynsim_2link_pl_a_T
#define typedef_f_cell_wrap_dynsim_2link_pl_a_T

typedef struct tag_8EP4ctv7s0SDnh3V6WCLOG f_cell_wrap_dynsim_2link_pl_a_T;

#endif                                 //typedef_f_cell_wrap_dynsim_2link_pl_a_T
...
#ifndef typedef_c_rigidBodyJoint_dynsim_2li_a_T
#define typedef_c_rigidBodyJoint_dynsim_2li_a_T

typedef struct tag_rHHvNgfpb6xtLaCol8pZFD c_rigidBodyJoint_dynsim_2li_a_T;

#endif                                 //typedef_c_rigidBodyJoint_dynsim_2li_a_T
...
{
  real_T Index;
  emxArray_char_T_dynsim_2link__T *NameInternal;
  c_rigidBodyJoint_dynsim_2li_a_T JointInternal;
  real_T ParentIndex;
};
...
#ifndef typedef_c_rigidBodyJoint_dynsim_2l_aw_T
#define typedef_c_rigidBodyJoint_dynsim_2l_aw_T

typedef struct tag_2xAJzS7rvIyFzfuC7FOGlD c_rigidBodyJoint_dynsim_2l_aw_T;

#endif                                 //typedef_c_rigidBodyJoint_dynsim_2l_aw_T
...
{
  emxArray_char_T_dynsim_2link__T *NameInternal;
  c_rigidBodyJoint_dynsim_2l_aw_T JointInternal;
  real_T ParentIndex;
};

#endif                                 //struct_tag_BPMfb1nwAW0cVckEDiFVnG

#ifndef typedef_n_robotics_manip_internal__aw_T
#define typedef_n_robotics_manip_internal__aw_T

typedef struct tag_BPMfb1nwAW0cVckEDiFVnG n_robotics_manip_internal__aw_T;

#endif                                 //typedef_n_robotics_manip_internal__aw_T
...
#ifndef typedef_o_robotics_manip_internal__aw_T
#define typedef_o_robotics_manip_internal__aw_T

typedef struct tag_EpnOXkcFkOFmcaZiu2CuCD o_robotics_manip_internal__aw_T;

#endif                                 //typedef_o_robotics_manip_internal__aw_T
...
{
  real_T NumBodies;
  o_robotics_manip_internal__aw_T Base;
  n_robotics_manip_internal__aw_T *Bodies[8];
  real_T PositionNumber;
};

#endif                                 //struct_tag_30tOpKFHjBx7LOwU1qyzZE

#ifndef typedef_p_robotics_manip_internal__aw_T
#define typedef_p_robotics_manip_internal__aw_T

typedef struct tag_30tOpKFHjBx7LOwU1qyzZE p_robotics_manip_internal__aw_T;

#endif                                 //typedef_p_robotics_manip_internal__aw_T
...
{
  int32_T isInitialized;
  p_robotics_manip_internal__aw_T TreeInternal;
};

#endif                                 //struct_tag_OhlsWxsKBuXkrIadR09rYF

#ifndef typedef_robotics_slmanip_internal__aw_T
#define typedef_robotics_slmanip_internal__aw_T

typedef struct tag_OhlsWxsKBuXkrIadR09rYF robotics_slmanip_internal__aw_T;

#endif                                 //typedef_robotics_slmanip_internal__aw_T
...
{
  f_cell_wrap_dynsim_2link_pl_a_T *data;
  int32_T *size;
  int32_T allocatedSize;
  int32_T numDimensions;
  boolean_T canFreeData;
...
typedef struct emxArray_tag_8EP4ctv7s0SDnh3V6W emxArray_f_cell_wrap_dynsim_2_T;
...
#ifndef typedef_emxArray_f_cell_wrap_dynsim_a_T
#define typedef_emxArray_f_cell_wrap_dynsim_a_T

typedef struct emxArray_tag_pGgszObO16I6TGXaEM emxArray_f_cell_wrap_dynsim_a_T;

#endif                                 //typedef_emxArray_f_cell_wrap_dynsim_a_T
