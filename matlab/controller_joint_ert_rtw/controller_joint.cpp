...
// C/C++ source code generated on : Tue May 26 16:55:34 2020
//
...
static void controller_jo_SystemCore_step_n(boolean_T *varargout_1, real_T
...
static void matlabCodegenHandle_matlabC_nlz(ros_slros_internal_block_GetP_T *obj);
...
static void controller_jo_SystemCore_step_n(boolean_T *varargout_1, real_T
  ...
  *varargout_2_Effort_SL_Info_Curr, uint32_T *varargout_2_Effort_SL_Info_Rece,
  real_T *varargout_2_TimeFromStart_Sec, real_T *varargout_2_TimeFromStart_Nsec)
{
  *varargout_1 = Sub_controller_joint_136.getLatestMessage
    (&controller_joint_B.b_varargout_2_m);
  *varargout_2_Positions_SL_Info_C =
    controller_joint_B.b_varargout_2_m.Positions_SL_Info.CurrentLength;
  *varargout_2_Positions_SL_Info_R =
    controller_joint_B.b_varargout_2_m.Positions_SL_Info.ReceivedLength;
  *varargout_2_Velocities_SL_Info_ =
    controller_joint_B.b_varargout_2_m.Velocities_SL_Info.CurrentLength;
  *varargout_2_Velocities_SL_Inf_0 =
    controller_joint_B.b_varargout_2_m.Velocities_SL_Info.ReceivedLength;
  *varargout_2_Accelerations_SL_In =
    controller_joint_B.b_varargout_2_m.Accelerations_SL_Info.CurrentLength;
  *varargout_2_Accelerations_SL__0 =
    controller_joint_B.b_varargout_2_m.Accelerations_SL_Info.ReceivedLength;
  memcpy(&varargout_2_Positions[0],
         &controller_joint_B.b_varargout_2_m.Positions[0], sizeof(real_T) << 7U);
  memcpy(&varargout_2_Velocities[0],
         &controller_joint_B.b_varargout_2_m.Velocities[0], sizeof(real_T) << 7U);
  memcpy(&varargout_2_Accelerations[0],
         &controller_joint_B.b_varargout_2_m.Accelerations[0], sizeof(real_T) <<
         7U);
  memcpy(&varargout_2_Effort[0], &controller_joint_B.b_varargout_2_m.Effort[0],
         sizeof(real_T) << 7U);
  *varargout_2_Effort_SL_Info_Curr =
    controller_joint_B.b_varargout_2_m.Effort_SL_Info.CurrentLength;
  *varargout_2_Effort_SL_Info_Rece =
    controller_joint_B.b_varargout_2_m.Effort_SL_Info.ReceivedLength;
  *varargout_2_TimeFromStart_Sec =
    controller_joint_B.b_varargout_2_m.TimeFromStart.Sec;
  *varargout_2_TimeFromStart_Nsec =
    controller_joint_B.b_varargout_2_m.TimeFromStart.Nsec;
}
...
void controller_joint_step(void)
{
  ...
  controller_jo_SystemCore_step_n(&b_varargout_1,
    controller_joint_B.b_varargout_2_Positions, &b_varargout_2_Positions_SL_Info,
    &b_varargout_2_Positions_SL_In_0,
    controller_joint_B.b_varargout_2_Velocities,
    &b_varargout_2_Velocities_SL_Inf, &b_varargout_2_Velocities_SL_I_0,
    controller_joint_B.b_varargout_2_Accelerations,
    &b_varargout_2_Accelerations_SL_, &b_varargout_2_Accelerations_S_0,
    controller_joint_B.b_varargout_2_Effort, &b_varargout_2_Effort_SL_Info_Cu,
    &b_varargout_2_Effort_SL_Info_Re,
    &controller_joint_B.b_varargout_2_TimeFromStart_Sec,
    &controller_joint_B.b_varargout_2_TimeFromStart_Nse);

  // Outputs for Enabled SubSystem: '<S5>/Enabled Subsystem' incorporates:
  //   EnablePort: '<S9>/Enable'

  if (b_varargout_1) {
    controller_joint_B.In1_l.Positions_SL_Info.CurrentLength =
      b_varargout_2_Positions_SL_Info;
    controller_joint_B.In1_l.Positions_SL_Info.ReceivedLength =
      b_varargout_2_Positions_SL_In_0;
    controller_joint_B.In1_l.Velocities_SL_Info.CurrentLength =
      b_varargout_2_Velocities_SL_Inf;
    controller_joint_B.In1_l.Velocities_SL_Info.ReceivedLength =
      b_varargout_2_Velocities_SL_I_0;
    controller_joint_B.In1_l.Accelerations_SL_Info.CurrentLength =
      b_varargout_2_Accelerations_SL_;
    controller_joint_B.In1_l.Accelerations_SL_Info.ReceivedLength =
      b_varargout_2_Accelerations_S_0;
    memcpy(&controller_joint_B.In1_l.Positions[0],
           &controller_joint_B.b_varargout_2_Positions[0], sizeof(real_T) << 7U);
    memcpy(&controller_joint_B.In1_l.Velocities[0],
           &controller_joint_B.b_varargout_2_Velocities[0], sizeof(real_T) << 7U);
    memcpy(&controller_joint_B.In1_l.Accelerations[0],
           &controller_joint_B.b_varargout_2_Accelerations[0], sizeof(real_T) <<
           7U);
    memcpy(&controller_joint_B.In1_l.Effort[0],
           &controller_joint_B.b_varargout_2_Effort[0], sizeof(real_T) << 7U);
    controller_joint_B.In1_l.Effort_SL_Info.CurrentLength =
      b_varargout_2_Effort_SL_Info_Cu;
    controller_joint_B.In1_l.Effort_SL_Info.ReceivedLength =
      b_varargout_2_Effort_SL_Info_Re;
    controller_joint_B.In1_l.TimeFromStart.Sec =
      controller_joint_B.b_varargout_2_TimeFromStart_Sec;
    controller_joint_B.In1_l.TimeFromStart.Nsec =
      controller_joint_B.b_varargout_2_TimeFromStart_Nse;
  }
  ...
  controller_join_SystemCore_step(&b_varargout_1,
    controller_joint_B.b_varargout_2_Name, &b_varargout_2_Positions_SL_Info,
    &b_varargout_2_Positions_SL_In_0, controller_joint_B.b_varargout_2_Positions,
    &b_varargout_2_Velocities_SL_Inf, &b_varargout_2_Velocities_SL_I_0,
    controller_joint_B.b_varargout_2_Velocities,
    &b_varargout_2_Accelerations_SL_, &b_varargout_2_Accelerations_S_0,
    controller_joint_B.b_varargout_2_Effort, &b_varargout_2_Effort_SL_Info_Cu,
    &b_varargout_2_Effort_SL_Info_Re, &controller_joint_B.b_varargout_2_Header);
  ...
  // Sum: '<Root>/Add1'
  for (i = 0; i < 6; i++) {
    controller_joint_B.Add[i] = controller_joint_B.In1_l.Positions[i] -
      controller_joint_B.In1.Position[i];
  }

  // End of Sum: '<Root>/Add1'

  // MATLABSystem: '<S6>/Get Parameter'
  ParamGet_controller_joint_93.get_parameter
    (&controller_joint_B.b_varargout_2_TimeFromStart_Sec);

  // MATLABSystem: '<S6>/Get Parameter1'
  ParamGet_controller_joint_94.get_parameter
    (&controller_joint_B.b_varargout_2_TimeFromStart_Nse);

  // MATLABSystem: '<S6>/Get Parameter2'
  ParamGet_controller_joint_95.get_parameter(&controller_joint_B.value);

  // MATLABSystem: '<S6>/Get Parameter3'
  ParamGet_controller_joint_96.get_parameter(&controller_joint_B.value_c);

  // MATLABSystem: '<S6>/Get Parameter4'
  ParamGet_controller_joint_97.get_parameter(&controller_joint_B.value_k);

  // MATLABSystem: '<S6>/Get Parameter5'
  ParamGet_controller_joint_98.get_parameter(&controller_joint_B.value_cx);
  ...
  controller_joint_B.d = controller_joint_B.Add[0];
  controller_joint_B.d1 = controller_joint_B.Add[1];
  controller_joint_B.d2 = controller_joint_B.Add[2];
  tmp = controller_joint_B.Add[3];
  tmp_0 = controller_joint_B.Add[4];
  tmp_1 = controller_joint_B.Add[5];
  controller_joint_B.Add[0] = controller_joint_B.d *
    controller_joint_B.b_varargout_2_TimeFromStart_Sec;
  controller_joint_B.Add[1] = controller_joint_B.d1 *
    controller_joint_B.b_varargout_2_TimeFromStart_Nse;
  controller_joint_B.Add[2] = controller_joint_B.d2 * controller_joint_B.value;
  controller_joint_B.Add[3] = tmp * controller_joint_B.value_c;
  controller_joint_B.Add[4] = tmp_0 * controller_joint_B.value_k;
  controller_joint_B.Add[5] = tmp_1 * controller_joint_B.value_cx;
  ...
  ParamGet_controller_joint_103.get_parameter
    (&controller_joint_B.b_varargout_2_TimeFromStart_Sec);

  // MATLABSystem: '<S7>/Get Parameter1'
  ParamGet_controller_joint_104.get_parameter
    (&controller_joint_B.b_varargout_2_TimeFromStart_Nse);

  // MATLABSystem: '<S7>/Get Parameter2'
  ParamGet_controller_joint_105.get_parameter(&controller_joint_B.value);

  // MATLABSystem: '<S7>/Get Parameter3'
  ParamGet_controller_joint_106.get_parameter(&controller_joint_B.value_c);

  // MATLABSystem: '<S7>/Get Parameter4'
  ParamGet_controller_joint_107.get_parameter(&controller_joint_B.value_k);

  // MATLABSystem: '<S7>/Get Parameter5'
  ParamGet_controller_joint_108.get_parameter(&controller_joint_B.value_cx);
...
{
  {
    ...
    controller_joint_B.In1_l = controller_joint_P.Out1_Y0_d;

    // End of SystemInitialize for SubSystem: '<S5>/Enabled Subsystem'

    // Start for MATLABSystem: '<S5>/SourceBlock'
    controller_joint_DW.obj_ez.matlabCodegenIsDeleted = false;
    controller_joint_DW.obj_ez.isInitialized = 1;
    for (i = 0; i < 17; i++) {
      tmp[i] = tmp_2[i];
    }

    tmp[17] = '\x00';
    Sub_controller_joint_136.createSubscriber(tmp, 1);
    controller_joint_DW.obj_ez.isSetupComplete = true;
...
void controller_joint_terminate(void)
{
  ...
  matlabCodegenHandle_matlabCod_n(&controller_joint_DW.obj_ez);
  ...
  matlabCodegenHandle_matlabC_nlz(&controller_joint_DW.obj_j);

  // Terminate for MATLABSystem: '<S6>/Get Parameter1'
  matlabCodegenHandle_matlabC_nlz(&controller_joint_DW.obj_l);

  // Terminate for MATLABSystem: '<S6>/Get Parameter2'
  matlabCodegenHandle_matlabC_nlz(&controller_joint_DW.obj_nc);

  // Terminate for MATLABSystem: '<S6>/Get Parameter3'
  matlabCodegenHandle_matlabC_nlz(&controller_joint_DW.obj_e);

  // Terminate for MATLABSystem: '<S6>/Get Parameter4'
  matlabCodegenHandle_matlabC_nlz(&controller_joint_DW.obj_j1);

  // Terminate for MATLABSystem: '<S6>/Get Parameter5'
  matlabCodegenHandle_matlabC_nlz(&controller_joint_DW.obj_f);

  // Terminate for MATLABSystem: '<S7>/Get Parameter'
  matlabCodegenHandle_matlabC_nlz(&controller_joint_DW.obj);

  // Terminate for MATLABSystem: '<S7>/Get Parameter1'
  matlabCodegenHandle_matlabC_nlz(&controller_joint_DW.obj_k);

  // Terminate for MATLABSystem: '<S7>/Get Parameter2'
  matlabCodegenHandle_matlabC_nlz(&controller_joint_DW.obj_a);

  // Terminate for MATLABSystem: '<S7>/Get Parameter3'
  matlabCodegenHandle_matlabC_nlz(&controller_joint_DW.obj_n);

  // Terminate for MATLABSystem: '<S7>/Get Parameter4'
  matlabCodegenHandle_matlabC_nlz(&controller_joint_DW.obj_nr);

  // Terminate for MATLABSystem: '<S7>/Get Parameter5'
  matlabCodegenHandle_matlabC_nlz(&controller_joint_DW.obj_as);
