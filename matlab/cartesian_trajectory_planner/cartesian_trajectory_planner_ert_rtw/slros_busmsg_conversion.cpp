...
// Conversions between SL_Bus_cartesian_trajectory_planner_ros_time_Duration and ros::Duration

void convertFromBus(ros::Duration* msgPtr, SL_Bus_cartesian_trajectory_planner_ros_time_Duration const* busPtr)
{
...
void convertToBus(SL_Bus_cartesian_trajectory_planner_ros_time_Duration* busPtr, ros::Duration const* msgPtr)
{
  const std::string rosMessageType("ros_time/Duration");
...
// Conversions between SL_Bus_cartesian_trajectory_planner_ros_time_Time and ros::Time

void convertFromBus(ros::Time* msgPtr, SL_Bus_cartesian_trajectory_planner_ros_time_Time const* busPtr)
{
...
void convertToBus(SL_Bus_cartesian_trajectory_planner_ros_time_Time* busPtr, ros::Time const* msgPtr)
{
  const std::string rosMessageType("ros_time/Time");
...
// Conversions between SL_Bus_cartesian_trajectory_planner_rosgraph_msgs_Clock and rosgraph_msgs::Clock

void convertFromBus(rosgraph_msgs::Clock* msgPtr, SL_Bus_cartesian_trajectory_planner_rosgraph_msgs_Clock const* busPtr)
{
...
void convertToBus(SL_Bus_cartesian_trajectory_planner_rosgraph_msgs_Clock* busPtr, rosgraph_msgs::Clock const* msgPtr)
{
  const std::string rosMessageType("rosgraph_msgs/Clock");
...
// Conversions between SL_Bus_cartesian_trajectory_plan_JointTrajectoryPoint_1eqsod and trajectory_msgs::JointTrajectoryPoint

void convertFromBus(trajectory_msgs::JointTrajectoryPoint* msgPtr, SL_Bus_cartesian_trajectory_plan_JointTrajectoryPoint_1eqsod const* busPtr)
{
...
void convertToBus(SL_Bus_cartesian_trajectory_plan_JointTrajectoryPoint_1eqsod* busPtr, trajectory_msgs::JointTrajectoryPoint const* msgPtr)
{
  const std::string rosMessageType("trajectory_msgs/JointTrajectoryPoint");
