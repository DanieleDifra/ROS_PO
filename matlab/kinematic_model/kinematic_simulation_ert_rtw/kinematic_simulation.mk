...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/kinematic_simulation.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/kinematic_simulation.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/kinematic_simulation_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/ros/slros/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -DMODEL=kinematic_simulation -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=1 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DROS_PROJECT -DMW_SCHED_OTHER -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT=RT
DEFINES_BUILD_ARGS = -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0
DEFINES_CUSTOM = 
DEFINES_OPTS = -DTID01EQ=1
DEFINES_SKIPFORSIL = -DROS_PROJECT -DMW_SCHED_OTHER -DSTACK_SIZE=64
DEFINES_STANDARD = -DMODEL=kinematic_simulation -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/kinematic_simulation_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/kinematic_simulation_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/kinematic_simulation_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
ert_main.cpp.o : $(START_DIR)/kinematic_simulation_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


kinematic_simulation.cpp.o : $(START_DIR)/kinematic_simulation_ert_rtw/kinematic_simulation.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slros_busmsg_conversion.cpp.o : $(START_DIR)/kinematic_simulation_ert_rtw/slros_busmsg_conversion.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slros_initialize.cpp.o : $(START_DIR)/kinematic_simulation_ert_rtw/slros_initialize.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
