...
// For Block kinematic_simulation/Joint_State_Msg_Creator/Get Joint Names/Get Parameter6
extern SimulinkParameterArrayGetter<char_T, std::string> ParamGet_kinematic_simulation_212;

// For Block kinematic_simulation/Robot Kinematic Model/initial_configurations/Get Parameter
extern SimulinkParameterGetter<real64_T, double> ParamGet_kinematic_simulation_158;

// For Block kinematic_simulation/Robot Kinematic Model/initial_configurations/Get Parameter1
extern SimulinkParameterGetter<real64_T, double> ParamGet_kinematic_simulation_159;

// For Block kinematic_simulation/Robot Kinematic Model/initial_configurations/Get Parameter2
extern SimulinkParameterGetter<real64_T, double> ParamGet_kinematic_simulation_160;

// For Block kinematic_simulation/Robot Kinematic Model/initial_configurations/Get Parameter3
extern SimulinkParameterGetter<real64_T, double> ParamGet_kinematic_simulation_161;

// For Block kinematic_simulation/Robot Kinematic Model/initial_configurations/Get Parameter4
extern SimulinkParameterGetter<real64_T, double> ParamGet_kinematic_simulation_162;

// For Block kinematic_simulation/Robot Kinematic Model/initial_configurations/Get Parameter5
