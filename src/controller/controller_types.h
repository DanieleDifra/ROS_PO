...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_controller_std_msgs_String_
#define DEFINED_TYPEDEF_FOR_SL_Bus_controller_std_msgs_String_
...
typedef struct {
  ...
  // IsVarLen=1:VarLenCategory=length:VarLenElem=Data
  SL_Bus_ROSVariableLengthArrayInfo Data_SL_Info;
} SL_Bus_controller_std_msgs_String;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_controller_ros_time_Time_
#define DEFINED_TYPEDEF_FOR_SL_Bus_controller_ros_time_Time_

// MsgType=ros_time/Time
typedef struct {
  real_T Sec;
  real_T Nsec;
} SL_Bus_controller_ros_time_Time;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_controller_std_msgs_Header_
#define DEFINED_TYPEDEF_FOR_SL_Bus_controller_std_msgs_Header_
...
typedef struct {
  ...
  // MsgType=ros_time/Time
  SL_Bus_controller_ros_time_Time Stamp;
} SL_Bus_controller_std_msgs_Header;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_controller_sensor_msgs_JointState_
#define DEFINED_TYPEDEF_FOR_SL_Bus_controller_sensor_msgs_JointState_
...
typedef struct {
  ...
  SL_Bus_controller_std_msgs_String Name[16];
  ...
  // MsgType=std_msgs/Header
  SL_Bus_controller_std_msgs_Header Header;
} SL_Bus_controller_sensor_msgs_JointState;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_controller_ros_time_Duration_
#define DEFINED_TYPEDEF_FOR_SL_Bus_controller_ros_time_Duration_

// MsgType=ros_time/Duration
typedef struct {
  real_T Sec;
  real_T Nsec;
} SL_Bus_controller_ros_time_Duration;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_controller_trajectory_msgs_JointTrajectoryPoint_
#define DEFINED_TYPEDEF_FOR_SL_Bus_controller_trajectory_msgs_JointTrajectoryPoint_
...
typedef struct {
  ...
  // MsgType=ros_time/Duration
  SL_Bus_controller_ros_time_Duration TimeFromStart;
} SL_Bus_controller_trajectory_msgs_JointTrajectoryPoint;
