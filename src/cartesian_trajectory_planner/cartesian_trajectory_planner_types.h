...
//
// File: cartesian_trajectory_planner_types.h
//
...
//
#ifndef RTW_HEADER_cartesian_trajectory_planner_types_h_
#define RTW_HEADER_cartesian_trajectory_planner_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_trajectory_planner_ros_time_Duration_
#define DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_trajectory_planner_ros_time_Duration_

// MsgType=ros_time/Duration
typedef struct {
  real_T Sec;
  real_T Nsec;
} SL_Bus_cartesian_trajectory_planner_ros_time_Duration;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_trajectory_plan_JointTrajectoryPoint_1eqsod_
#define DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_trajectory_plan_JointTrajectoryPoint_1eqsod_
...
typedef struct {
  ...
  // MsgType=ros_time/Duration
  SL_Bus_cartesian_trajectory_planner_ros_time_Duration TimeFromStart;
} SL_Bus_cartesian_trajectory_plan_JointTrajectoryPoint_1eqsod;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_trajectory_planner_ros_time_Time_
#define DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_trajectory_planner_ros_time_Time_

// MsgType=ros_time/Time
typedef struct {
  real_T Sec;
  real_T Nsec;
} SL_Bus_cartesian_trajectory_planner_ros_time_Time;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_trajectory_planner_rosgraph_msgs_Clock_
#define DEFINED_TYPEDEF_FOR_SL_Bus_cartesian_trajectory_planner_rosgraph_msgs_Clock_

// MsgType=rosgraph_msgs/Clock
typedef struct {
  // MsgType=ros_time/Time
  SL_Bus_cartesian_trajectory_planner_ros_time_Time Clock_;
} SL_Bus_cartesian_trajectory_planner_rosgraph_msgs_Clock;
...
#endif                      // RTW_HEADER_cartesian_trajectory_planner_types_h_
